		...
		try:
			while True:
				...
				if cmd == "":
					...
					print " force <arg>      force a subprocess.Popen (risk of session loss)"
					print " force2 <arg>     force a os.system (risk of session loss)"
					print
					print
					print "Other"
					print "====="
					print
					print " getchromecookie  recover the cookie recorded on chrome"
